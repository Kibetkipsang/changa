...
export const createChama = async (req, res) => {
    try {
...
export const joinChama = async (req, res) => {
    try {
...
export const getMyChamas = async (req, res) => {
    try {
        const userId = req.user?.id;
...
export const getChamaById = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const members = chama.memberships.map((m) => ({
            id: m.user.id,
            name: m.user.name,
            email: m.user.email,
            phone: m.user.phone,
...
// ============================================
export const exitChama = async (req, res) => {
    try {
...
// ============================================
export const requestChamaDeletion = async (req, res) => {
    try {
        const { chamaId } = req.params;
        const userId = req.user?.id;
...
// ============================================
export const approveChamaDeletion = async (req, res) => {
    try {
        const { chamaId } = req.params;
        const userId = req.user?.id;
...
// ============================================
export const rejectChamaDeletion = async (req, res) => {
    try {
        const { chamaId } = req.params;
...
// ============================================
export const confirmChamaDeletion = async (req, res) => {
    try {
        const { chamaId } = req.params;
        const userId = req.user?.id;
...
//# sourceMappingURL=ChamaControllers.js.map